...
import (
	...
	tmpl "github.com/hixuym/devctl/internal/new/template"
)
...
func protoComments(goDir, alias string) []string {
	return []string{
		...
		"go get -u github.com/asim/go-micro/v3/cmd/protoc-gen-micro",
...
func init() {
	cmd.Register(&cli.Command{
		Name:        "new",
		Usage:       "Create a go-micro service template",
		Description: `'devctl new' scaffolds a new service skeleton. Example: 'devctl new helloworld && cd helloworld'`,
		Action:      Run,
	})
}
